...
var ResponseTypes = require('./config.json')['types'];
...
var FlashLoader = function(connection, encoding) {
    ...
    this.load = function(program, id, mode) {
            ...
            return function(callback) {
                ...
                function listen(response) {
                    switch (response.type) {
                        case ResponseTypes.FLASH_PROGRESS:
                            clearTimeout(timer);
                            emitProgress('flash', {
                            ...
                            break;
                        case ResponseTypes.FLASH_COMPLETE:
                            parser.removeListener('response', listen);
                            clearTimeout(timer);
                            emitProgress('flash', {
                                total: program.lines
        ...
        function sendChecksumData(callback) {
            console.log('Sending checksum data');
